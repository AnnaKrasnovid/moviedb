    ...
    <section className='movies-description'>
      <div className='about-movie'>
        ...
        <div className='about-movie__container'>
          ...
          <p className='about-movie__title-en'></p>
          ...
          <ul className='about-movie__box-main'>
            <li className='about-movie__box-info-main'>
              <p className='about-movie__heading'>Жанр</p>
              <p className='about-movie__info'>Боевик, Комедия, Драма</p>
            </li>
            <li className='about-movie__box-info-main'>
              <p className='about-movie__heading'>Жанр</p>
              <p className='about-movie__info'>Боевик, Комедия, Драма</p>
          ...
          <div className='about-movie__box-description'>
            ...
            <p className='about-movie__description'>Идейные соображения высшего порядка, а также сложившаяся структура организации
